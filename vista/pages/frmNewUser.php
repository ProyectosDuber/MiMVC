                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="../../controladores/controladorDePersona.php?action=crear">
                                        <div class="form-group">
                                            <label>Cedula de Usuario</label>
                                            <input name="cedula" id="cedula" class="form-control" placeholder="Cedula">
                                        </div>
                                         <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input name="apellidos" id="apellidos" class="form-control" placeholder="Apellidos">
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input name="fechaDeNacimiento" id="fechaDeNacimiento" class="form-control" placeholder="aaaa-mm-dd">
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label>Direccion de Usuario</label>
